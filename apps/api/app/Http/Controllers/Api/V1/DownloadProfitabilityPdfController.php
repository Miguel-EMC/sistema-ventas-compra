...
use App\Application\Services\Reports\ProfitabilityPdfService;
use App\Http\Controllers\Controller;
use App\Http\Requests\Reports\ReportOverviewRequest;
use Symfony\Component\HttpFoundation\Response;

class DownloadProfitabilityPdfController extends Controller
{
    public function __invoke(
        ReportOverviewRequest $request,
        BusinessInsightsService $insightsService,
        ProfitabilityPdfService $pdfService,
    ): Response {
